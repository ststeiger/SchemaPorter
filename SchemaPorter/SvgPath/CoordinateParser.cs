    ...
    internal class CoordinateParser
    {
        ...
        public bool TryGetFloat(out float result)
        {
            while (i < _coords.Length && _parseWorked)
            {
                ...
                {
                    result = float.Parse(_coords.Substring(_pos, i - _pos)
            ...
            {
                result = float.Parse(_coords.Substring(_pos, _coords.Length - _pos), System.Globalization.NumberStyles.Float, System.Globalization.CultureInfo.InvariantCulture);
                _pos = _coords.Length;
                return MarkState(true);
            }
        }
