...
namespace Svg.Pathing
{
        ...
        : SvgPathSegment
    {
        ...
        private const double DoublePI = System.Math.PI * 2;
        ...
        {
            double ta = System.Math.Atan2(uy, ux);
            double tb = System.Math.Atan2(vy, vx);
        ...
        public override void AddToPath(GraphicsPath graphicsPath)
        {
            ...
            double sinPhi = System.Math.Sin(this.Angle * SvgArcSegment.RadiansPerDegree);
            double cosPhi = System.Math.Cos(this.Angle * SvgArcSegment.RadiansPerDegree);
            ...
            if (numerator < 0.0)
            {
                float s = (float)System.Math.Sqrt(1.0 - numerator / (this.RadiusX * this.RadiusX * this.RadiusY * this.RadiusY));
            ...
            {
                root = ((this.Size == SvgArcSize.Large && this.Sweep == SvgArcSweep.Positive) || (this.Size == SvgArcSize.Small && this.Sweep == SvgArcSweep.Negative) ? -1.0 : 1.0) * System.Math.Sqrt(numerator / (this.RadiusX * this.RadiusX * y1dash * y1dash + this.RadiusY * this.RadiusY * x1dash * x1dash));
            }
            ...
            int segments = (int)System.Math.Ceiling((double)System.Math.Abs(dtheta / (System.Math.PI / 2.0)));
            double delta = dtheta / segments;
            double t = 8.0 / 3.0 * System.Math.Sin(delta / 4.0) * System.Math.Sin(delta / 4.0) / System.Math.Sin(delta / 2.0);
            ...
            {
                double cosTheta1 = System.Math.Cos(theta1);
                double sinTheta1 = System.Math.Sin(theta1);
                double theta2 = theta1 + delta;
                double cosTheta2 = System.Math.Cos(theta2);
                double sinTheta2 = System.Math.Sin(theta2);
        ...
        public override string ToString()
        {
        	...
        	return "A" + this.RadiusX.ToString() + " " + this.RadiusY.ToString() + " " + this.Angle.ToString() 
                + " " + arcFlag + " " + sweepFlag + " " + this.End.ToSvgString();
        }
    }
