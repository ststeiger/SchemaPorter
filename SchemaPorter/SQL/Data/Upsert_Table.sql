...
SELECT
	 LOWER(REPLACE(@in_table, 'T_', 'tbl_')) AS variable_name 
	,N'DECLARE @' + LOWER(REPLACE(@in_table, N'T_', N'tbl_')) + N' table(
' + 
(
SELECT 
	...
	+ ' '
	+ DDL_NAME 
	+ CASE WHEN IS_NULLABLE = N'NO' THEN N' NOT NULL' ELSE N'' END 
	+ NCHAR(13) + NCHAR(10) 
	AS [text()] 
